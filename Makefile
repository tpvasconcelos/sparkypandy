...
jupyter-init: ## initialise a jupyterlab environment and install extensions
	.venv/bin/python -m ipykernel install --user --name="sparkypandy"
...
test: ## run tests quickly with the default Python
	.venv/bin/pytest --cov=sparkypandy --cov=tests --cov-report=xml tests
...
docs: ## generate Sphinx HTML documentation, including API docs
	#rm -f docs/sparkypandy.rst
	#rm -f docs/modules.rst
	#sphinx-apidoc -o docs/ sparkypandy
